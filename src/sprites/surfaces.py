...
CURRENT_INANIMATED_PROPS = {
	...
	"RIGHT_BU	TTONS_PANEL": setup_surfaces.ALL_INANIMATED_PROPS["RIGHT_BUTTONS_PANEL"]["all_off"],
	"LEFT_DOOR"          : setup_surfaces.ALL_INANIMATED_PROPS["LEFT_DOOR"          ]["open" ],
	"RIGHT_DOOR"         : setup_surfaces.ALL_INANIMATED_PROPS["RIGHT_DOOR"         ]["open" ],
}
