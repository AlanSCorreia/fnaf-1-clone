...
from src.ecs import components, systems
...
#TODO: tirar esta função daqui para animations
def set_direction(
...
# TODO: Isso definitivamente não deveria estar aqui, talvez até mesmo existir
